    ...
    <main className="faq">
      <div className="faq__holder">
        ...
        <details className="faq__detail">
          <summary className="faq__summary"><span className="faq__question">Pourquoi s'inscrire sur notre site ?</span></summary>
          <p className="faq__text">En vous inscrivant sur O'Food,on va vous proposer les meilleures recettes selon votre profil, vous pourrez manger sain et facile</p>
        </details>
        ...
        <details className="faq__detail">
          ...
          <p className="faq__text">Vous pouvez nous contacter soit via le lien "contact" soit nos reseaux sociaux !</p>
          <p className="faq__text">Le tout se trouve tout en bas de la page.</p>
        </details>

        <details className="faq__detail">
          <summary className="faq__summary"><span className="faq__question">Je n'aime pas les recettes proposé et je souhaite les changer.</span></summary>
